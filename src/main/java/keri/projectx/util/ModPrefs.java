...
public class ModPrefs {
    ...
    public static final String DEPS = "required-after:ninetaillib;after:waila;after:thermalfoundation;after:thermalexpansion;after:chisel;after:mantle;after:tconstruct";

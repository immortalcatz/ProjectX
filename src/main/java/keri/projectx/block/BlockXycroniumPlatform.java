...
public class BlockXycroniumPlatform extends BlockAnimationHandler {

    @SideOnly(Side.CLIENT)
    private TextureAtlasSprite texture;

    public BlockXycroniumPlatform() {
        super("xycronium_platform", Material.ROCK, EnumDyeColor.toStringArray());
    ...
    public void registerIcons(IIconRegister register) {
        this.texture = register.registerIcon(ModPrefs.MODID + ":blocks/xycronium_platform");
    }

...
public class BlockXycroniumBricksChiseled extends BlockAnimationHandler {

    @SideOnly(Side.CLIENT)
    private TextureAtlasSprite texture;

    public BlockXycroniumBricksChiseled() {
        super("xycronium_bricks_chiseled", Material.ROCK, EnumXycroniumColor.toStringArray());
    ...
    public void registerIcons(IIconRegister register) {
        this.texture = register.registerIcon(ModPrefs.MODID + ":blocks/xycronium_bricks_chiseled");
    }

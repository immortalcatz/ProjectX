...
class BlockXycroniumBricksChiseled extends BlockProjectX("xycronium_bricks_chiseled", Material.ROCK, EnumXycroniumColor.toStringArray) with TBlockAnimationHandler {
  setHardness(1.4F)
